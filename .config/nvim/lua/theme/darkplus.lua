...
local function config()
	...
	vim.api.nvim_set_hl(0, "LeapLabelPrimary", { fg = "#AAFF00", bold = true, nocombine = true })
	vim.api.nvim_set_hl(0, "LeapLabelSecondary", { fg = "#BF40BF", bold = true, nocombine = true })
	vim.api.nvim_set_hl(0, "LeapLabelSecondary", { fg = "#0096FF", bold = true, nocombine = true })
