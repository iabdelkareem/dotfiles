...
local function register_keymaps()
  vim.keymap.set("n", "<leader>ff", function()
    require("finder.finders").find_files()
  end, { desc = "Find Files" })
  ...
  vim.keymap.set("n", "<leader>Fr", function()
    require("finder.finders").find_files({ default_text = "Request" })
  end, { desc = "Find Requests" })

  vim.keymap.set("n", "<leader>FR", function()
    require("finder.finders").find_files({ default_text = "Repository" })
  end, { desc = "Find Repositories" })

  vim.keymap.set("n", "<leader>Fh", function()
    require("finder.finders").find_files({ default_text = "Handler" })
...
local function config()
  ...
  local custom_actions = require("finder.actions")
